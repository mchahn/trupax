...
public class Wipe {
    static final String PROPS_PFX = "wipe.";
    ...
    public abstract static class __test_CHECK {
    ...
    static final int MAX_PATH_PAD_LEN = 198;
    ...
    static final char[] RENAME_CHARSET = ("abcdefghijklmnopqrstuvwxyz" +
