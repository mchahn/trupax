...
public abstract class Prg {
    ...
    /**
     * Returns the version number in the common "major.minor.patch" format.
    ...
    public static final int MAX_LABEL_LEN = 15;
     ...
     */
    protected abstract static class Struct implements Serializable {
    ...
    public static class Result extends Struct {
        ...
        static final Result _ok = new Result(Code.OK, null, null);
         ...
         */
        public static final Result internalError(Throwable err) {
    ...
    public static class Prop {
        static final String PFX = "trupax.prg.";
         ...
         * Boolean.
         */
        public static final String RECURSIVE_SEARCH = PFX + "recursivesearch";
        /**
         ...
         * registered. Boolean.
         */
        public static final String STORE_FULL_PATH = PFX + "storefullpath";
        /**
         ...
         */
        public static final String TRIM_PATH = PFX + "trimpath";
        /**
         * Whether empty directories should be registered or not. Boolean.
         */
        public static final String SKIP_EMPTY_DIRS = PFX + "skipemptydirs";
        /**
         ...
         */
        public static final String ALLOW_MERGE = PFX + "allowmerge";
        /**
         ...
         */
        public static final String CASE_MERGE = PFX + "casemerge";
        /**
         ...
         */
        public static final String OVERWRITE = PFX + "overwrite";
        /**
         ...
         */
        public static final String WRITEPROTECT = PFX + "writeprotect";
        /**
         * The name of the block cipher to use. Default is "AES256". String.
         */
        public static final String BLOCK_CIPHER = PFX + "blockcipher";
        /**
         * The name of the hash function to use. Default is "SHA-512". String.
         */
        public static final String HASH_FUNCTION = PFX + "hashfunction";
        /**
         ...
         */
        public static final String KEEP_BROKEN_VOLUME = PFX + "keepbrokenvolume";
        /**
         * Label the next created volume should have. Can be any text up to 15
         * characters long. Default is &quot;&quot;. String.
         */
        public static final String LABEL = PFX + "label";
        /**
         * Whether an invalidated volume should also be deleted. Boolean.
         */
        public static final String DELETE_AFTER = PFX + "deleteafter";
        /**
         * If the volume should be made for VeraCrypt. Boolean.
         */
        public static final String FOR_VERACRYPT = PFX + "forveracrypt";
    }

    ///////////////////////////////////////////////////////////////////////////

    /**
     * Setup information for construction time. It can also be prepared in a
     * way where there are no global things used at all, for example to run a
     * transient instance for volume creation in a server.
     */
    ...
    public interface RegisterObjectsCallbacks {
        /**
    ...
    public interface MakeCallback extends FileCallback {
        ...
        /**
         * Called if the key generation started, since this might take a while.
         * @return Whether to continue (OK) or not (ABORTED).
         */
     ...
     * @return Result of the operation.
     */
    public abstract Result registerObjects(RegisterObjectsCallbacks cb);
